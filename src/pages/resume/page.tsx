...
const ResumePage = () => {
  ...
  const handleViewResume = () => {
    window.open("/AmritrajLamba_Resume(Final).pdf", "_blank");
  };

  const handleDownloadResume = () => {
    const link = document.createElement("a");
    link.href = "/AmritrajLamba_Resume(Final).pdf";
  ...
  const education = [
    {
      degree: "IB Diploma",
      field: "Grade 11 and Grade 12",
      institution: "",
      year: "Aug 2024 - May 2026",
      details: [
        "Relevant Coursework: HL Math Analysis and Approaches, HL Chemistry, HL Physics, SL Economics, SL French B, SL English A Language and Literature",
      ],
    },
    {
      degree: "IGCSE",
      ...
      details: [
        "10/10 A*s",
        "School Topper in Additional Mathematics, School Topper in Chemistry",
      ],
    },
    {
      degree: "Standardized Test Scores",
      field: "",
      institution: "",
      year: "2025",
      details: [
  ...
  const researchPapers = [
    ...
    },
    {
      ...
      type: "",
      details: [
        "Used satellite imagery and GIS to show shorelines protected by healthy reefs had less than half the erosion of areas with degraded reefs.",
        "Provided evidence to integrate reef restoration into climate adaptation strategies for cities like Mumbai and Chennai, complementing engineered defenses.",
        "Recognition included publication in the International Journal of Environmental Sciences and mentorship from Prof. Umang Soni, with validation in competitive research platforms.",
      ],
    },
  ];
  ...
  const summerPrograms = [
    {
      ...
      details: [
        ...
        "Prototypes developed during the program reflected this rigorous approach, and faculty feedback validated the professional grounding in product innovation.",
      ],
    },
    {
      title: "Launch X",
    ...
    },
    {
      ...
      details: [
        ...
        "Capstone on linear algebra and projective geometry; improved modeling intuition later applied to CFD and robot mechanisms.",
  ...
  const advancedCourses = [
    ...
    {
      title: "World International Mathematics Olympiad Training Course",
      company: "",
      period: "January 2024",
      type: "",
      details: [
        "Professional Mathematical Olympiad training provided by Olympiad Champion Education Group at University of Malaya, Kuala Lumpur, Malaysia",
      ],
    },
  ];
  ...
  const socialImpact = [
    {
      title: "Teens of God",
      company: "Regd. Local NGO",
      period: "Aug 2022 - Dec 2024",
      type: "",
      details: [
        "Mentor/Tutor teaching basic Math and Science concepts to underprivileged children.",
        "One of the lead members of the NGO's robotics branch, where we taught concepts of robotics and circuits using donated STEM kits.",
      ],
    },
    {
      title: "Signal Stars",
      company: "FTC Outreach Initiative, Thane",
