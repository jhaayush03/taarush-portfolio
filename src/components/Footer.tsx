import { Linkedin, Instagram, Twitter, Mail, Heart, ArrowUp } from "lucide-react";

const Footer = () => {
  const currentYear = new Date().getFullYear();

  const socialLinks = [
    { icon: Linkedin, href: "https://linkedin.com", label: "LinkedIn", color: "from-blue-600 to-blue-400" },
    { icon: Instagram, href: "https://instagram.com", label: "Instagram", color: "from-pink-600 via-purple-600 to-orange-500" },
    { icon: Twitter, href: "https://twitter.com", label: "Twitter", color: "from-cyan-500 to-blue-500" },
    { icon: Mail, href: "mailto:hello@example.com", label: "Email", color: "from-green-500 to-emerald-400" },
  ];
  ...
  return (
    <footer className="relative overflow-hidden bg-gradient-to-b from-background via-secondary/40 to-secondary/70 border-t border-border">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -left-40 w-80 h-80 bg-gradient-to-br from-accent/20 to-purple-500/20 rounded-full blur-3xl animate-pulse" 
             style={{ animationDuration: '4s' }} />
        <div className="absolute -bottom-40 -right-40 w-96 h-96 bg-gradient-to-br from-blue-500/20 to-cyan-500/20 rounded-full blur-3xl animate-pulse" 
             style={{ animationDuration: '5s', animationDelay: '1s' }} />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-gradient-to-br from-purple-500/10 to-pink-500/10 rounded-full blur-3xl animate-pulse" 
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-12 mb-16">
            ...
            <div className="space-y-4 group">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Building systems at the intersection of people, data and
                technology.
              </p>
          ...
          <div className="flex justify-center gap-4 mb-8">
            {socialLinks.map((social, index) => (
              ...
              >
                {/* Gradient background */}
                <div className={`absolute inset-0 bg-gradient-to-br ${social.color} opacity-80 group-hover:opacity-100 transition-opacity duration-300`} />
                {/* Glow effect */}
                <div className={`absolute inset-0 bg-gradient-to-br ${social.color} blur-lg opacity-0 group-hover:opacity-70 transition-opacity duration-300`} />
